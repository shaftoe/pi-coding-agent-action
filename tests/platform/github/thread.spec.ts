  ...
  test('stops fetching when page returns fewer items than perPage', async () => {
    ...
    (deps.octokit.rest.issues.listComments as any).mockImplementation(() => {
      ...
      return Promise.resolve({
        data: [
          { id: 1, user: { login: 'u1' }, created_at: '2025-01-01T00:00:00Z', updated_at: null, body: 'c1' },
          { id: 2, user: { login: 'u2' }, created_at: '2025-01-01T00:00:00Z', updated_at: null, body: 'c2' },
          { id: 3, user: { login: 'u3' }, created_at: '2025-01-01T00:00:00Z', updated_at: null, body: 'c3' },
        ],
      });
    });
