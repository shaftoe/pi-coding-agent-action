...
describe('addReaction', () => {
  ...
  test('uses correct repo owner and name', async () => {
    ...
    const callArgs = (deps.octokit.rest.reactions.createForIssueComment as any).mock.calls[0] as any[];
...
describe('deleteReaction', () => {
  ...
  test('uses correct reaction ID from reaction response', async () => {
    ...
    const callArgs = (deps.octokit.rest.reactions.deleteForIssueComment as any).mock.calls[0] as any[];
