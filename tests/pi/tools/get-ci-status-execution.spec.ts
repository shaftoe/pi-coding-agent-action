/**
 * @file Execution tests for the get_ci_status and get_workflow_run_logs tools.
 *
 * Verifies that the tools correctly forward parameters to the platform
 * provider and return well-formed results.
 */
/* eslint-disable @typescript-eslint/no-explicit-any */
import { describe, expect, test, mock } from 'bun:test';
import { getCIStatusToolFactory, getWorkflowRunLogsToolFactory } from '../../../src/pi/tools/get-ci-status';
...
describe('get_ci_status tool - execution', () => {
  ...
  test('execute propagates provider errors', async () => {
    ...
    await expect(
      tool.execute('call-error', {}, undefined, undefined, mockCtx)
