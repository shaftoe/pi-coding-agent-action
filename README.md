...
```yaml
   uses: shaftoe/pi-coding-agent-action@v2.26.0
```
...
| `@earendil-works/pi-agent-core` | `0.81.1` | Pi Agent Core — agent orchestration primitives |
| `@earendil-works/pi-ai` | `0.81.1` | Pi AI — AI model abstractions and providers |
| `@earendil-works/pi-coding-agent` | `0.81.1` | Pi SDK — AI coding agent runtime |
