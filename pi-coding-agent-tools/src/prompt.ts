/**
 * @file Prompt strings for Pi coding agent tool definitions.
 *
 * Contains the system prompt, descriptions, guidelines, and parameter
 * descriptions consumed by the tool definitions. Centralising these strings
 * makes them easy to review and update in one place.
 */
