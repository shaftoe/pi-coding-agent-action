...
/**
 * GitHub-specific Octokit reaction response types.
 *
 * These are the concrete types behind the opaque `CreateReactionType` defined
 * in the orchestrator's PlatformProvider interface.
 */
