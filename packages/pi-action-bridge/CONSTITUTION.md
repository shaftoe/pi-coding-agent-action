...
> **Date:** 2026-06-15
> **Status:** Design v0.16 — `--steer` dropped (redundant with the conversation + the HITL edit, contradicts §2.5); `/handoff` now takes only `-y`/`--yes`
