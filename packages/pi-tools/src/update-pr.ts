...
/**
 * Create the update_pull_request tool definition bound to a tool provider.
 *
 * @param provider - The tool provider for PR update operations.
 * @returns The tool definition.
 */
export function updatePullRequestToolFactory(provider: ToolProvider) {
  return defineTool({
